...
module.exports = {
  ...
  */
  ...
  Files to watch
  */
  watch: ['node_modules/**/**', 'dist/**/**', 'templates/**/*.php', 'template-parts/**/*.php', 'woocommerce/**/*.php', '*.php'],
  ...
  */
  publicPath: '/wp-content/themes/eventlin',

  devUrl: 'https://eventlin.test',
  ...
  translation: {
    ...
    team: 'Oblak Solutions <office@oblak.studio>',
  },
};
